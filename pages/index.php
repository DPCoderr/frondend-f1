            ...
            <div class="container-lg">
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-12 col-md-6 mb-5" id="leaderboard" >   
                        ...
                        <a href="/pages/upcoming-race.php" class="d-md-none text-white">Click here for the full leaderboard on this race</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="all-races" class="mt-4 mb-5">
            <div class="container-lg">
                ...
                <div class="row">
                    ...
                    <!-- Link to go to the full page -->
                    <a href="/pages/all-races.php" class="text-white">Click here for all the races</a>
                </div>
            </div>
        </section> 
    </main>
